(function () {
  ...
  SC.diamond = {
    render: function (atBat) {
      ...
      var fontSize = notation === "HR" ? 14 : (notation.length > 3 ? 10 : (notation.length > 2 ? 11 : 12));
      ...
      if (atBat.isOut && atBat.outNumber > 0) {
        svg += '<circle cx="50" cy="50" r="6" class="out-circle"/>';
        svg += '<text x="50" y="51" class="out-num">' + atBat.outNumber + '</text>';
      }
